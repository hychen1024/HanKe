...
NSString *const MJRefreshHeaderIdleText = @"下拉可以扫描设备";
NSString *const MJRefreshHeaderPullingText = @"松开立即扫描设备";
NSString *const MJRefreshHeaderRefreshingText = @"正在扫描水疗设备中...";
