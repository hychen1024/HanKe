...
+(instancetype) buttonWithNormalImage:(NSString *)normalImg highlightedImage:(NSString *)highlightedImg callback:(MGSwipeButtonCallback) callback{
    MGSwipeButton * button = [self buttonWithType:UIButtonTypeCustom];
    ...
    button.callback = callback;
    [button setEdgeInsets:UIEdgeInsetsMake(0, 25, 0, 25)];
    return button;
}
