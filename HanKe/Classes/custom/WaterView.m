...
//        self.currentWaterColor = [UIColor colorWithRed:86/255.0f green:202/255.0f blue:139/255.0f alpha:1];
//        self.currentLinePointY = 250;
...
- (void)setRatio:(float)ratio{
    if (ratio >= 0 && ratio <= 1.0) {
        ...
        _currentLinePointY = (1 - _ratio) * height;
    }else{
        _ratio = 0;
    }
}
